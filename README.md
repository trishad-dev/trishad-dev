...
### 🔍 The Journey
* **Current Focus:** Mastering CS fundamentals (Programming, Logic Design, and Mathematics).
* **The Pivot:** Moving from life sciences to silicon—leveraging my analytical skills to solve digital problems and bringing a fresh perspective to Software Development.
* **Vibe Coding :** Exploring how LLms can augment traditional programming to build impactful solutions faster. 
* **Goal:** To evolve into a full-stack developer who builds software that makes a tangible impact.
...
* 🎨**AI Assets:** CreaoAI for generative design and creative workflows.

**Design and stratergy**
* 📶**Visualization:** Canva  and Microsoft PowerPoint for professional storytelling.
* 🤝**Networking:** Active on LinkedIn and Unstop to track industry trends and compete.
